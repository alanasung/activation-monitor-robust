...
This note situates **How Brittle Are Activation Monitors Under Distribution Shift** against the mentor-linked literature for
[How Brittle Are Activation Monitors Under Distribution Shift](https://github.com/alanasung/activation-monitor-robust).

## Positioning

Stress-test activation monitors for deception/harm signals under shift and simple adaptive attacks.

The design hypothesis is: Stress-test activation monitors for deception/harm signals under shift and simple adaptive attacks.
