"""Experiment stages for How Brittle Are Activation Monitors Under Distribution Shift."""
...
from .actmon._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "How Brittle Are Activation Monitors Under Distribution Shift", "claims_gated": True})
